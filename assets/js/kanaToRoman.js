 ...
 */
 var kanaToRoman = function(targetStr, type, options) {
    ...
    var romanMap = {
        ...
        'こ' : 'ko',
        'さ' : 'sa',
        'し' : { hepburn : 'shi', kunrei : 'si', my : 'si'  },
        'す' : 'su',
        'せ' : 'se',
        'そ' : 'so',
        'た' : 'ta',
        'ち' : { hepburn : 'chi', kunrei : 'ti', my : 'ti' },
        'つ' : { hepburn : 'tsu', kunrei : 'tu', my : 'tu' },
        'て' : 'te',
        'と' : 'to',
        'な' : 'na',
        'に' : 'ni',
        ...
        'ご' : 'go',
        'ざ' : 'za',
        'じ' : { hepburn : 'ji', kunrei : 'zi', my : 'zi' },
        'ず' : 'zu',
        'ぜ' : 'ze',
        'ぞ' : 'zo',
        'だ' : 'da',
        'ぢ' : { hepburn : 'ji', kunrei : 'di', my : 'di' },
        'づ' : { hepburn : 'zu', kunrei : 'du', my : 'du' },
        'で' : 'de',
        'ど' : 'do',
        'ば' : 'ba',
        'び' : 'bi',
        ...
        'くゅ' : 'qyu',
        'くょ' : 'qyo',
        'しゃ' : { hepburn : 'sha', kunrei : 'sya', my : 'sya' },
        'しぃ' : 'syi',
        'しゅ' : { hepburn : 'shu', kunrei : 'syu', my : 'syu' },
        'しぇ' : 'sye',
        'しょ' : { hepburn : 'sho', kunrei : 'syo', my : 'syo' },
        'ちゃ' : { hepburn : 'cha', kunrei : 'tya', my : 'tya' },
        'ちぃ' : ['tyi'],
        'ちゅ' : { hepburn : 'chu', kunrei : 'tyu', my : 'tyu' },
        'ちぇ' : ['tye'],
        'ちょ' : { hepburn : 'cho', kunrei : 'tyo', my : 'tyo' },
        'てゃ' : 'tha',
        'てぃ' : 'thi',
        'てゅ' : 'thu',
        'てぇ' : 'the',
        ...
        'ぎぇ' : 'gye',
        'ぎょ' : 'gyo',
        'じゃ' : { hepburn : 'ja', kunrei : 'zya', my : 'ja' },
        'じぃ' : 'zyi',
        'じゅ' : { hepburn : 'ju', kunrei : 'zyu', my : 'ju' },
        'じぇ' : 'zye',
        'じょ' : { hepburn : 'jo', kunrei : 'zyo', my : 'jo' },
        'ぢゃ' : { hepburn : 'dya', kunrei : 'zya', my : 'zya' },
        'ぢぃ' : 'dyi',
        'ぢゅ' : { hepburn : 'dyu', kunrei : 'zya', my : 'zya' },
        'ぢぇ' : 'dye',
        'ぢょ' : { hepburn : 'dyo', kunrei : 'zya', my : 'zya' },
        'びゃ' : 'bya',
        'びぃ' : 'byi',
        'びゅ' : 'byu',
        'びぇ' : 'bye',
    ...
    if (typeof type !== 'string' || !type.match(/^(hepburn|kunrei|my)$/)) type = 'hepburn';
